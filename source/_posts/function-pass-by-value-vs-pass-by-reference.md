...
之前写过一篇[文章(1)](https://blog.csdn.net/KSroido/article/details/110145270?spm=1001.2014.3001.5501)简单区分了一下指针变量和普通变量的区别
...
由于笔者主要接触的是汇编语言,于是舍弃了原文当中的C++例子,采用此汇编例子,看不懂该例子的话可以去看一下原文的例子